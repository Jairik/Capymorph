...
![Morphy Sprite Animation](docs/Morphy-animation.gif)
...
### The Maze
![Morphy in the Maze](docs/demo-maze.png)
*Morphy navigating the maze looking for snacks.*

### Questions
![Question Modal](docs/demo-question.png)
*Answering morpheme questions while navigating the path.*

### Leaderboards
![Leaderboard Modal](docs/demo-leaderboard.png)
